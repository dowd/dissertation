...
results=ddply(os_results,~City+Type,summarise,
              'Mean Distance'=mean(Points.Distance),
              'Total in OS'=sum(!is.na(City)),
              'Mean distance under 50m'=mean(Points.Distance[Points.Distance<50]),
              'Standard Deviation under 50m'=sd(Points.Distance[Points.Distance<50]))
